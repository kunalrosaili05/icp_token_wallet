...
import { idlFactory } from './wallet_project_frontend.did.js';
export { idlFactory } from './wallet_project_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WALLET_PROJECT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wallet_project_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wallet_project_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wallet_project_frontend.did.js")._SERVICE>}
 */
export const wallet_project_frontend = createActor(canisterId);
